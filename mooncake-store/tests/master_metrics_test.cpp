...
TEST_F(MasterMetricsTest, BasicRequestTest) {
    ...
    auto put_end_result2 = service_.PutEnd(client_id, key, "default", ReplicaType::MEMORY);
    ...
    auto put_end_result3 = service_.PutEnd(client_id, key, "default", ReplicaType::MEMORY);
...
TEST_F(MasterMetricsTest, CalcCacheStatsTest) {
    ...
    auto put_start_result1 =
        service_.PutStart(client_id, key, "default", value_length, config);
    ASSERT_TRUE(put_start_result1.has_value());
    auto put_end_result1 = service_.PutEnd(client_id, key, "default", ReplicaType::MEMORY);
...
TEST_F(MasterMetricsTest, BatchRequestTest) {
    ...
    auto batch_put_start_result =
        service_.BatchPutStart(client_id, keys, "default", value_lengths, config);
    ...
    auto batch_get_replica_result = service_.BatchGetReplicaList(keys, "default");
    ...
    auto batch_put_end_result = service_.BatchPutEnd(client_id, keys, "default");
    ...
    auto batch_get_replica_result2 = service_.BatchGetReplicaList(keys, "default");
    ...
    auto batch_put_revoke_result = service_.BatchPutRevoke(client_id, keys, "default");
    ...
    auto batch_get_replica_result3 = service_.BatchGetReplicaList(keys, "default");
...
TEST_F(MasterMetricsTest, PutStartReplicaAllocationFailureMetric) {
    ...
    auto put_start_result = service_.PutStart(
        generate_uuid(), "allocation_failure_key", "default", 1024, config);
